...
// 写入数据
U32 addrShort1 = 0x0800C000 + 10 * 8; // 1
U32 addrShort2 = 0x0800C000 + 12 * 8; // 2
...
void W_Test(void)
{
  System_WriteInteriorFlash(addrShort1, (uint8_t *)&Data_init.Flage, sizeof(Data_init.Flage)); // 存入数据，函数内自动解锁，擦除，写入
	System_WriteInteriorFlash(addrShort2, (uint8_t *)&threshold_value_init.soil_value, sizeof(threshold_value_init.soil_value));
	System_WriteInteriorFlash(addrShort3, (uint8_t *)&threshold_value_init.temp_value, sizeof(threshold_value_init.temp_value));
	System_WriteInteriorFlash(addrShort4, (uint8_t *)&threshold_value_init.light_value, sizeof(threshold_value_init.light_value));
	System_WriteInteriorFlash(addrShort5, (uint8_t *)&threshold_value_init.somg_value, sizeof(threshold_value_init.somg_value));
}
// 读取数据
void R_Test(void)
{
  System_ReadInteriorFlash(addrShort1, (uint8_t *)&Data_init.Flage, sizeof(Data_init.Flage)); // 存入数据，函数内自动解锁，擦除，写入
	System_ReadInteriorFlash(addrShort2, (uint8_t *)&threshold_value_init.soil_value, sizeof(threshold_value_init.soil_value));
	System_ReadInteriorFlash(addrShort3, (uint8_t *)&threshold_value_init.temp_value, sizeof(threshold_value_init.temp_value));
	System_ReadInteriorFlash(addrShort4, (uint8_t *)&threshold_value_init.light_value, sizeof(threshold_value_init.light_value));
	System_ReadInteriorFlash(addrShort5, (uint8_t *)&threshold_value_init.somg_value, sizeof(threshold_value_init.somg_value));
}
/*********************************************************************************
